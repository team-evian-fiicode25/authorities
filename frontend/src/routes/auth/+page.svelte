...
>
    ...
    <fieldset class="fieldset w-full">
        ...
        <input disabled={isLoading} type="text" class="input w-full" name="username" value={form?.username ?? ""} />
    </fieldset>
    <fieldset class="fieldset w-full">
        <legend class="fieldset-legend">Password</legend>
        <input disabled={isLoading} type="password" class="input w-full" name="password" />
    </fieldset>
    <button disabled={isLoading} type="submit" class="btn btn-primary mt-4 w-full">Submit</button>
    {#if form?.error}
